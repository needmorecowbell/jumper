...
def main_master(host, hostPort, customer, customerPort):
    ...
    communicate_addr = (host, int(hostPort))
    customer_listen_addr = (customer, int(customerPort))
...
if __name__ == '__main__':
    ...
    main_master(host, hostPort, customer, customerPort)
